...
function Today(props){
    ...
    const {todaysHabits} = useContext(TodayHabitsCont)
    const {HabitsStatus} = useContext(HabitsStatusCont)
    ...
    return(
        ...
        <Content>
            ...
            <Percentagep>{percentage}% dos hábitos concluídos</Percentagep>:
